        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="box box-warning direct-chat direct-chat-warning">
                    ...
                    <div class="box-body">
                        ...
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg">
                                ...
                                <!-- /.direct-chat-info -->
                                <img class="direct-chat-img" src="{{asset ('resource/dist/img/user1-128x128.jpg')}}"
                            ...
                            <div class="direct-chat-msg right">
                                ...
                                <!-- /.direct-chat-info -->
                                <img class="direct-chat-img" src="{{asset ('resource/dist/img/user3-128x128.jpg')}}"
                                     alt="message user image">
                                <!-- /.direct-chat-img -->
                                <div class="direct-chat-text">
                    ...
                    {{--<li>--}}
                    {{--<a href="#">--}}
                    {{--<img class="contacts-list-img" src="{{asset ('resource/dist/img/user1-128x128.jpg')}}"--}}
                    {{--alt="User Image">--}}
